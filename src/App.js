...
function App() {
  return (
    ...
    <div className="App">
      ...
      <Card size={'Small'} title={'Mailbox Finder'} description={'Mailbox Finder is the easiest way to find the PO boxes around you when you need them.'} color={'grey-100'}/>
